...
function addcause() {
  return (
    <div className='h-screen w-full bg-zinc-900 px-20 py-10 text-white'>
        ...
        <h1 className='text-5xl font-neue mt-2 '>Add Cause</h1>
        </div>
        <form action="" className='flex flex-col gap-4 w-[800px] items-start'>
            <input type="text" placeholder='Cause Name' className='text-4xl px-4 py-2 rounded-mg  outline-none bg-zinc-600 font-light'/>
